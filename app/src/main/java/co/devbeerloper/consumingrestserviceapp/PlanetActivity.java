...
public class PlanetActivity extends AppCompatActivity {
    ...
    private TextView[] atributes=new TextView[9];
    public static final String URL_SWAPI = "https://swapi.co/api/";
    public String[]cualities=new String[9];
    private int index=1;
    public int n=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list=findViewById(R.id.atLayout2);
    ...
    public void callWebService(String serviceEndPoint){
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL urlService = new URL (URL_SWAPI + "planets/"+index+"/" );
                    ...
                    if (connection.getResponseCode() == 200) {
                        ...
                        atributes[1].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[1].setText("Periodo de rotacion: "+ cualities[1]);
                            }
                        });
                        ...
                        atributes[2].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[2].setText("Periodo orbital: "+ cualities[2]);
                            }
                        });
                        ...
                        atributes[3].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[3].setText("Diametro: "+ cualities[3]);
                            }
                        });
                        ...
                        atributes[4].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[4].setText("Clima: "+ cualities[4]);
                            }
                        });
                        ...
                        atributes[5].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[5].setText("Gravity: "+ cualities[5]);
                            }
                        });
                        ...
                        atributes[6].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[6].setText("Terreno: "+ cualities[6]);
                            }
                        });
                        ...
                        atributes[7].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[7].setText("Superficie de agua: "+ cualities[7]);
                            }
                        });
                        atributes[8].post(new Runnable() {
                            @Override
                            public void run() {
                                atributes[8].setText("Población: "+ cualities[7]);
                            }
                        });
